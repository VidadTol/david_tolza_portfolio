      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-center items-stretch">
          <a
            ...
            className="flex-1 flex flex-col items-center justify-center bg-white text-blue-700 rounded-2xl p-8 hover:shadow-2xl transition-all font-bold text-2xl"
          >
            <Phone className="w-15 h-15 mb-5" />
            APPELER MOI <br /> 06 87 23 26 67
          </a>
          <a
            href="mailto:vidadtol31@gmail.com"
            className="flex-1 flex flex-col items-center justify-center bg-white text-blue-700 rounded-2xl p-8 hover:shadow-2xl transition-all font-bold text-2xl"
          >
            <Mail className="w-15 h-15 mb-5" />
