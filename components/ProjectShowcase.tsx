...
export default function ProjectShowcase() {
  ...
  const techBadges = [
    { src: "https://img.shields.io/badge/Next.js-black?style=for-the-badge&logo=next.js&logoColor=white", alt: "Next.js", label: "Performance" },
    { src: "https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=for-the-badge&logo=tailwind-css&logoColor=white", alt: "Tailwind CSS", label: "Stylisation" },
    { src: "https://img.shields.io/badge/Firebase-FFCA28?style=for-the-badge&logo=firebase&logoColor=black", alt: "Firebase", label: "Gestion des données" },
    { src: "https://img.shields.io/badge/Stripe-626CD9?style=for-the-badge&logo=stripe&logoColor=white", alt: "Stripe", label: "Sécurité des paiements" },
    { src: "https://img.shields.io/badge/RGPD-Audit-2ecc71?style=for-the-badge", alt: "Audit RGPD", label: "Conformité légale" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-slate-400 text-justify leading-relaxed">
              ...
              >
                "Les Créas d'Isa"
              </a> complète avec gestion de stocks en temps réel et paiement sécurisé.
            </p>

            <div className="flex flex-wrap gap-2 mt-6">
              {techBadges.map((badge, index) => (
                <img key={index} src={badge.src} alt={badge.alt} title={badge.label} className="h-6 hover:opacity-80 transition-opacity" />
              ))}
            </div>
          ...
          <div className="relative h-48 md:h-56 flex justify-center items-center">
            ...
            <div className="w-[75%] rounded-lg overflow-hidden border border-slate-700 shadow-lg transform group-hover:-rotate-1 transition-all duration-500 z-10">
              <img src="/page-accueil-pc.png" alt="Preview PC" className="w-full h-auto opacity-80 group-hover:opacity-100" />
            </div>
            ...
            <div className="absolute bottom-0 right-0 md:right-4 z-20 group-hover:z-30">
              <div className="relative">
                {/* Label */}
                <div className="absolute -top-6 -right-2 bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded transform rotate-12 shadow-lg">
                  Mobile
                </div>
                {/* Image */}
                <div className="w-24 md:w-32 rounded-xl overflow-hidden border-4 border-slate-950 shadow-2xl transform translate-y-0 group-hover:-translate-y-3 group-hover:rotate-3 transition-all duration-500 bg-white">
                  <img src="/page-accueil-mobile.png" alt="Preview Mobile" className="w-full h-auto" />
                </div>
              </div>
            </div>
          </div>
